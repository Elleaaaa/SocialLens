...
FIRST_SCAN_DAYS_LIMIT = 7
FIRST_SCAN_POST_CAP = 100  # Safety cap on first scan to avoid exhaustive grid scrolling
...
MAX_POSTS_TO_DATE = 0
INSTAGRAM_SCROLL_ROUNDS = 5
POST_DATE_WAIT_MS = 10000
USER_AGENT = (
...
FB_SCROLL_ROUNDS = 10
FB_STALE_SCROLLS = 3
FB_SCROLL_DELAY_MS = 2000

THREADS_SCROLL_ROUNDS = 10
THREADS_STALE_SCROLLS = 3
THREADS_SCROLL_DELAY_MS = 2000

TIKTOK_SCROLL_ROUNDS = 5
